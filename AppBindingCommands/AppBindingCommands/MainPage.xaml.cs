...
namespace AppBindingCommands
{
    public partial class MainPage : ContentPage
    {
        ...
        private void btnAtualizarInfo_Click(object sender, EventArgs e)
        {
            ...
            if (Application.Current.Properties.ContainsKey("AcaoStar"))
                informacoes += Application.Current.Properties["AcaoStar"];
